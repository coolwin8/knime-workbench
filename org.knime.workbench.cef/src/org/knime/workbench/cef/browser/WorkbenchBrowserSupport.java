...
public class WorkbenchBrowserSupport extends AbstractWorkbenchBrowserSupport {
     ...
     */
    @Override
    public IWebBrowser createBrowser(final int style, final String browserId, final String name, final String tooltip)
        throws PartInitException {
        return new WebBrowser(browserId, name, tooltip);
    }
